# 수동 라벨링 패킷 (Top 10, 빠른 시작) — 골든 페어

> 빠른 첫 정확도 테스트용 상위 10개 고가치 페어 (4개 페르소나 모두 포함).
...
- 총 10쌍 · 페르소나 분포: {'junior_frontend': 4, 'devops_infra_security': 3, 'ai_ml_application': 2, 'backend_platform': 1} · 카테고리 분포: {'same_domain_close': 5, 'adjacent_vs_primary': 4, 'domain_transfer': 1}
- 난이도 분포: {'hard': 10} · 모드 불일치 쌍 수: 9
...
---
## 9. prop-ai_ml_application-02  ·  [domain_transfer]  ·  난이도 hard (hardness 4)  ·  ⚠ 모드 불일치
- **persona:** `ai_ml_application`  ·  résumé: `data/eval/resumes/ai_ml_application.md`
...
---
## 10. prop-backend_platform-01  ·  [same_domain_close]  ·  난이도 hard (hardness 4)
